...
{{--upper div--}}
    ...
    <div class="container mt-5">
        ...
        <form id="filterForm" method="GET" action="{{route('transfer.filter')}}">
            <div class="row gap-2">
                <a type="button" href="{{route('transfer.create')}}" class="btn col-sm-4 col-lg-3 add border text-danger">
                    عملية ايداع جديدة
                    <i class="fa-solid fa-plus"></i>
                </a>
                @auth
                    @if(auth()->user()->role === 'Admin')
                        <a type="button" href="{{ route('account.create') }}" class="btn col-sm-4 col-lg-2 add border text-danger">
                            انشاء محاسب
                            <i class="fa-solid fa-plus"></i>
                        </a>
                    @endif
            ...
            <div class="row gap-2 gap-md-1 mt-2">
                ...
                <div class="date col-sm-3 col-md-5 col-lg-3 col-xl-2">
                ...
                <div class="col-sm-5 col-md-4 col-xl-2 me-xl-auto">
                    ...
                    <button id="clearFilters" class="btn btn-danger bg-danger border-danger" type="reset">الغاء</button>
                </div>
            </div>
        </form>
        <div class="container mt-4">
            <div class="row mb-3 gap-2">
                ...
                <div class="d-flex justify-content-sm-end justify-content-center mt-2 mt-md-0">
        ...
        <div class="table-responsive">
            <table class="table" id="dataTable">
                <thead>
                <tr>
                    <th class="align-middle">رقم العملية</th>
                    <th>نوع العملية</th>
                    <th>المبلغ</th>
                    <th>تاريخ التحويل</th>
                    <th>اسم المحول</th>
